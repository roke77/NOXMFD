...
A squad leader (see [SQD](sqd.md)) can share any route with their squad — it shows up for members
as a read-only entry with ACCEPT/REJECT. Later edits by the leader re-broadcast automatically, and
an accepted route unlocks for editing once the squad ends or the leader stops being leader.
