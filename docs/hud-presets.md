...
| [`src/web/pages/hud/hud.html`](../src/web/pages/hud/hud.html), [`hud.js`](../src/web/pages/hud/hud.js), [`hud.css`](../src/web/pages/hud/hud.css) | The bottom bar, SAVE/LOAD wiring, `fetchPresetItems` (on-demand `/hud-presets` fetch for the LOAD list only — the bottom label rides the existing HUD-options snapshot). |
