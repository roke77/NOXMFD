...
| 4 | Split rates: contacts ~3–4 Hz; RWR/MW + own-ship 10 Hz | both | M | Cuts contact rebuild cost; preserves fast own-ship/threat cues | **DONE** — contact/RDR/HSD/pitbull snapshots rebuild at 4 Hz and are reused by fast frames |
