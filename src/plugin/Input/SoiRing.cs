...
namespace NOXMFD
{
    ...
    // a hand-written JS mirror model (tools/tests/soi-focus.test.js, which also models SoiFocus's
    // stateful exclusion/disconnect rules). SoiFocus.cs supplies the live inputs and owns all the
