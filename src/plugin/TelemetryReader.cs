    ...
    internal class TelemetryReader : MonoBehaviour
    {
        ...
        private void PushSnapshot()
        {
            ...
            TelemetryServer.Push(new TelemetrySnapshot
            {
                ...
                TgpMag          = _tgp.Mag,
                TgpRangeM       = _tgp.RangeM,
                TgpGrid         = _tgp.Grid,
                TgpIR           = _tgp.IR,
                TgpBearingDeg   = _tgp.BearingDeg,
                TgpTargetCount  = _tgp.TargetCount,
                TgpType         = _tgp.TargetType,
                TgpPilot        = _tgp.Pilot,
                TgpStatus       = _tgp.Status,
                TgpHasDetail    = _tgp.HasDetail,
                TgpHeadingDeg   = _tgp.HeadingDeg,
                TgpAltitudeM    = _tgp.AltitudeM,
