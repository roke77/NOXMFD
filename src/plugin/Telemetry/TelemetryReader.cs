    ...
    internal class TelemetryReader : MonoBehaviour
    {
        ...
        private void PushSnapshot()
        {
            ...
            TelemetryServer.Push(new TelemetrySnapshot
            {
                ...
                TgpRangeReading = UnitConverter.DistanceReading(_tgp.Overlay.RangeM),
                ...
                TgpAltReading      = UnitConverter.AltitudeReading(_tgp.Overlay.AltitudeM),
                TgpRelAltReading   = UnitConverter.AltitudeReading(_tgp.Overlay.RelAltitudeM),
                TgpSpeedReading    = UnitConverter.SpeedReading(_tgp.Overlay.SpeedMps),
                TgpRelSpeedReading = UnitConverter.SpeedReading(_tgp.Overlay.RelSpeedMps),
