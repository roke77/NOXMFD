namespace NOXMFD
{
    ...
    // MasterArmsOn/CombatMode have no game-side field to patch, so they're reset here per aircraft
    // instead of at spawn via HarmonyPatches. Neither persists across restart; only ImmersionConfig does.
