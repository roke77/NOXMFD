...
(function () {
  ...
  // bezel is unaffected (there HUD and BDF are their own BEZEL_EXTRAS keys). HUD and BDF each have an
  // F35_PAGES entry (docs/bdf-page.md) and render as real pages; PAL has none, so it still renders
  // greyed and inert like any unimplemented action — no special case needed.
