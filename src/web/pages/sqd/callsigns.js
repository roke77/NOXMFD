...
// which aircraft type a callsign was originally associated with — plus PHANTOM, SENTINEL and
// TALON, which players asked for. Kept alphabetical so the SQD page's <select> is scannable, not
...
export const SQUAD_CALLSIGNS = [
  ...
  'PHANTOM', 'PIG', 'PINPOINT', 'PLAYBOY', 'POINTER', 'PONTIAC', 'PYTHON', 'RAGE', 'RAGIN', 'RAM',
  'RATTLER', 'ROMAN', 'SABER', 'SCORPION', 'SENTINEL', 'SHABA', 'SHELL', 'SIOUX', 'SLED', 'SNAKE',
  'SNIPER', 'SPRINGFIELD', 'SQUID', 'STING', 'TAHOE', 'TALON', 'TEXACO', 'THUD', 'TRASH', 'TREK',
  'TUSK', 'UZI', 'VADER', 'VENOM', 'VIPER', 'WARRIOR', 'WEASEL', 'WHIPLASH', 'WILD', 'WIZARD',
  'WOLF',
];
